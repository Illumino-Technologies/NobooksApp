...
class StorageApi<T>
  ...
  static Future<void> initialize() async {
    ...
    await Hive.openBox<Map<String, dynamic>>(StorageKey.user.box);
    await Hive.openBox<Map<String, dynamic>>(StorageKey.note.box);
    await Hive.openBox<Iterable<Map<String, dynamic>>>(
