...
class RecordGraph extends ConsumerStatefulWidget {
  const RecordGraph({Key? key}) : super(key: key);

  @override
  ConsumerState<RecordGraph> createState() => _DashboardScreenState();
}

class _DashboardScreenState extends ConsumerState<RecordGraph> {
  List<Color> gradientColors = [AppColors.blue00, AppColors.white];
