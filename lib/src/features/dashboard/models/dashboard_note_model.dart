class DashboardNoteModel{
  ...
  DashboardNoteModel({required this.title, required this.subTitle, 
  required this.bottomtitle, required this.bottomsubTitle, required this.firstImage, required this.secondImage});}
