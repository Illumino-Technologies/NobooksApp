...
final List<Notification> notification = [
  Notification(
      ...
      '30 mins ago',
      Assets.book),
  Notification('A new assignment has been dropped by your Chemistry teacher',
      '2 hours ago', Assets.book),
  Notification('You have a Maths test scheduled for tomorrow by 8:00am',
      '5 hours ago', Assets.book),
  Notification(
